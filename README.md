...
- Post a [github issue](https://github.com/senecajs/seneca-gateway/issues)
- Tweet to [@senecajs](http://twitter.com/senecajs)
- Ask on the [Gitter](https://gitter.im/senecajs/seneca)

## API

See [source](https://github.com/senecajs/seneca-gateway) for API details.
